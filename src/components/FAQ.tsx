...
const faqs = [
  ...
  },
  {
    ...
    a: 'В стоимость входит трансфер Астана – лагерь – Астана. Сопровождающий вожатый находится с детьми на протяжении всего пути.',
  },
  {
  ...
  },
  {
    ...
    a: 'Трансфер (Астана – лагерь – Астана), 5-разовое питание, полная программа лагеря, фирменная кепка LingvoCamp и ежедневный фото- и видеоотчёт в Telegram-канале.',
  },
  {
